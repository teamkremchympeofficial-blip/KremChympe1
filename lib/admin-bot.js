...
const TEXT_KEYS = [
  ...
  { key: 'confirm.headline.cancelled', label: 'Confirmation page headline (once guide rejects)', defaultValue: 'Booking Rejected' },
  ...
  { key: 'confirm.status.cancelled', label: 'Rejected status banner text', defaultValue: 'Booking Rejected ❌ — please contact the tour guide for details.' },
